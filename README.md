...
Давид Митков
243052
Cekor 3 Ciklicna vrednost ja presmetav so formulata V(G) = P + 1, deka so P e brojo na jazli so se if for while uslovi. Za searchBookbyTitle toa se: if (title.isEmpty()), for (Book book : books), if (condition1 && condition2), if (results.isEmpty()).Znaci V(G) = 4+1 = 5, 
